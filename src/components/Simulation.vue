...
<script lang="ts">
  ...
  function useSimulation(props: { parameters: IParameters }) {
    const state = reactive({
      ...
      columnasVisibles: [
        'evento', 'reloj', 'numero-pedido',
        'tipo-producto', 'cantidad-pedida', 'llegada-proximo-pedido',
        'cola-pedidos-preparar',
        'stock-miga', 'stock-pizza', 'stock-hamburguesa', 'stock-lomito', 'stock-empanadas',
        'srv1-estado', 'srv1-numero-pedido', 'srv1-prox-fin-at',
        'srv2-estado', 'srv2-numero-pedido', 'srv2-prox-fin-at',
        'srv3-estado', 'srv3-numero-pedido', 'srv3-prox-fin-at',
        'cola-pedidos-entregar',
        'srvDelivery-estado', 'srvDelivery-pedidos-entregar', 'srvDelivery-prox-fin-en',
      ],
